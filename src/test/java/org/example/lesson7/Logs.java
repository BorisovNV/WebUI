...
public class Logs extends AbstractTest {

    @Test
    @DisplayName("Пустой скрипт")
    @Description("Тест ни о чем. Такие не нужны")
    ...
    @Description("Тест скриншота")
    @Link("http://google.com")
    @Issue("https://bbc.com")
    @Severity(SeverityLevel.BLOCKER)
    void testFalse() throws InterruptedException, IOException {
        Thread.sleep(1000);
        File file = MyUtils.makeScreenshot(getWebDriver(),"failure- org.example.bbc.Logs.testFalse" + System.currentTimeMillis() + ".png");
